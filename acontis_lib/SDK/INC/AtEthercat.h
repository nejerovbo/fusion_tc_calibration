...
/* Pearf measurement API functions */
...
\note Must be called after initialization and before configuration
*/
static EC_INLINESTART  EC_T_DWORD emSetOemKey(      EC_T_DWORD              dwInstanceID,   /**< [in] Master Instance ID */
...
*/
static EC_INLINESTART  EC_T_DWORD emBadConnectionsReset(   EC_T_DWORD      dwInstanceID     /**< [in] Master Instance ID */
                                                       )
{

...
typedef struct _EC_T_LINK_PARMS
{
    ...
    EC_T_DWORD      dwInstance;                              /**< [in] Instance of the adapter */
...
typedef struct _EC_T_LINK_TTS
{
    ...
    EC_T_DWORD                  dwSendOffsetUsec;       /**< [in] Time between pfnStartCycle call and frame transmition */
...
#define EC_LINK_PARMS_SIGNATURE_SOCKRAW_VERSION (EC_T_DWORD)0x00000003
...
{
    EC_T_LINK_PARMS linkParms;      /**< Common link parameters. Signature must be set to EC_LINK_PARMS_SIGNATURE_RIN32M3 */
} EC_PACKED_API EC_T_LINK_PARMS_RIN32M3;
#include EC_PACKED_INCLUDESTOP
...
#define EC_LINK_PARMS_SIGNATURE_ICSS_VERSION (EC_T_DWORD)0x00000005
...
#define EC_LINK_PARMS_SIGNATURE_SIMULATOR_VERSION (EC_T_DWORD)0x00000005
...
typedef struct _EC_T_LINK_PARMS_SIMULATOR
{
    ...
    /* topology parameters */
    EC_T_CHAR   szEniFilename[EC_SIMULATOR_ENI_FILE_NAME_SIZE]; /**< optional: create slaves from ENI/EXI (zero terminated string) */
    ...
    /* adapter parameters */
    EC_T_BYTE   abyMac[6];                                      /**< MAC station address */
    EC_T_DWORD  dwRxBufferCnt;                                  /**< Frame buffer count for IST */

    /* application specific */
    EC_T_BOOL   bJobsExecutedByApp;                             /**< EC_FALSE: esExecJob explicitely called by application, EC_TRUE: implicitely by emllSimulator */
    ...
    EC_T_DWORD  dwRasPriority;                                  /**< RAS server thread priority */

...
#define ETH_ADDRESS_MASTER_RED_FORWARD_MASK_MAIN        (0x04) /* 1st byte of Organisationally Unique Identifier (OUI) containing the Store and forward at MAIN bit 0x04 */
#define ETH_ADDRESS_MASTER_RED_FORWARD_MASK_RED         (0x80) /* 1st byte of Organisationally Unique Identifier (OUI) containing the Store and forward at RED bit 0x80 */
...
#define ETH_ADDRESS_MASTER_RED_FORWARD_OFFSET           (0)    /* 1st byte of Organisationally Unique Identifier (OUI) containing the Store and forward bits 0x14 */
...
#define ETH_ADDRESS_RETRY_FRAME_OFFSET                  (0)    /* 1st byte of Organisationally Unique Identifier (OUI) containing the Retry counter bits 0x70 */
#define ETH_ADDRESS_RETRY_FRAME_MASK                    (0x70) /* 1st byte of Organisationally Unique Identifier (OUI) containing the Retry counter bits 0x70 */
...
/* reset 1st 2 bytes of Organisationally Unique Identifier (OUI) containing
   ETH_ADDRESS_CABLE_RED_MASK, ETH_ADDRESS_MASTER_RED_FORWARD_MASK, ETH_ADDRESS_FORWARDING_RULE_MASK, ETH_ADDRESS_RETRY_FRAME_MASK, ETH_ADDRESS_CABLE_RED_FRAME_ID_MASK */
#define EC_RESET_ETH_SRC_ADDRESS(p)                     OsMemset(p,0,2)
...
{
    EC_T_VOID* pvContext;
    EC_T_BYTE (*pfRead)(EC_T_VOID* pvContext, EC_T_WORD wIndex, EC_T_BYTE bySubindex, EC_T_DWORD dwSize, EC_T_BYTE* pbyData, EC_T_BOOL bCompleteAccess); /**< \brief Optional function pointer called on object access */
    EC_T_BYTE (*pfWrite)(EC_T_VOID* pvContext, EC_T_WORD wIndex, EC_T_BYTE bySubindex, EC_T_DWORD dwSize, EC_T_BYTE* pbyData, EC_T_BOOL bCompleteAccess); /**< \brief Optional function pointer called on object access */
...
static EC_INLINESTART EC_T_DWORD EC_ECINITCMDDESC_GET_INITCMDTIMEOUT(PEcInitCmdDesc p)
{
    return EC_GETDWORD((((EC_T_PBYTE)p) + EC_ECINITCMDDESC_OFFS_INITCMDTIMEOUT));
} EC_INLINESTOP

static EC_INLINESTART EC_T_DWORD EC_ECINITCMDDESC_GET_RETRIES(PEcInitCmdDesc p)
{

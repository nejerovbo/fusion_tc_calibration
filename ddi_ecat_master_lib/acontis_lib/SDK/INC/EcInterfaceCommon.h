...
{
    EC_T_BOOL               bIsCyclicFrame;         /**< EC_TRUE if the frame contains cyclic commands */
    EC_T_FRAME_RSPERR_TYPE  EErrorType;             /**< Error type */
...
typedef struct _EC_T_DC_SYNC_NTFY_DESC
{
    ...
    EC_T_DWORD      dwDeviation;        /**< [in] Wire or'ed deviation value in nanoseconds in case of "in sync" */
    EC_T_SLAVE_PROP SlaveProp;          /**< [in] Slave properties in case of "not in sync" */
...
typedef struct _EC_T_DCM_SYNC_NTFY_DESC
{
    ...
    EC_T_INT        nCtlErrorNsecCur;   /**< [in] Current difference between set value and actual value of controller in nanosec */
    EC_T_INT        nCtlErrorNsecAvg;   /**< [in] Average difference between set value and actual value of controller in nanosec */
    EC_T_INT        nCtlErrorNsecMax;   /**< [in] Maximum difference between set value and actual value of controller in nanosec */
...
typedef struct _EC_T_BUS_DIAGNOSIS_INFO
{
    ...
    EC_T_DWORD dwNumMbxSlaves;          /**< Number of slaves with mailbox support */
...
{
    EC_T_INT                    nCtlSetVal;                 /**< [in] Controller set value in nanoseconds. This is the time distance between the cyclic frame send time and the DC base on bus (SYNC0 if shift is zero). */
    ...
    EC_T_DWORD                  dwInSyncLimit;              /**< [in] Limit in nsec for InSync monitoring. Default value is 4000. A value of 0 let the current setting unmodified */
...
typedef struct _EC_T_COE_ENTRYDESC
{
    ...
    EC_T_BYTE   byValueInfo;                        /**< Bit mask to define which information is available */
...
#define EC_T_CMF_CMD_DEVICE_FLAG_MASTERRED_DATA_RX     0x8 /* master red data received last cycle */

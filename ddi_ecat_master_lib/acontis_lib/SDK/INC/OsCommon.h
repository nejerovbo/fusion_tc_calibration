...
/** \brief Reads a value of type EC_T_WORD (16 bits) at given pointer. The value is swapped on big endian systems.
\param ptr [in] Source buffer
\return EC_T_WORD value (16 bits) from buffer. 
*/
#define EC_GET_FRM_WORD(ptr)        EC_GETWORD((ptr))
/** \brief Reads a value of type EC_T_DWORD (32 bits) at given pointer. The value is swapped on big endian systems.
\param ptr [in] Source buffer
\return EC_T_DWORD value (32 bits) from buffer.
*/
#define EC_GET_FRM_DWORD(ptr)       EC_GETDWORD((ptr))
/** \brief Reads a value of type EC_T_QWORD (64 bits) at given pointer. The value is swapped on big endian systems.
\param ptr [in] Source buffer
\return EC_T_QWORD value (64 bits) from buffer.
*/
#define EC_GET_FRM_QWORD(ptr)       EC_GETQWORD((ptr))

#define EC_SET_FRM_BOOL(ptr,b)      EC_SETBOOL((ptr),(b))
/** \brief Writes a value of type EC_T_WORD (16 bits) at given pointer. The value is swapped on big endian systems.
\param ptr [in] Destination buffer
\param w   [in] 16 bit value
*/
#define EC_SET_FRM_WORD(ptr,w)      EC_SETWORD((ptr),(w))
/** \brief Writes a value of type EC_T_DWORD (32 bits) at given pointer. The value is swapped on big endian systems.
\param ptr [in] Destination buffer
\param dw  [in] 32 bit value
*/
#define EC_SET_FRM_DWORD(ptr,dw)    EC_SETDWORD((ptr),(dw))
/** \brief Writes a value of type EC_T_QWORD (64 bits) at given pointer. The value is swapped on big endian systems.
\param ptr [in] Destination buffer

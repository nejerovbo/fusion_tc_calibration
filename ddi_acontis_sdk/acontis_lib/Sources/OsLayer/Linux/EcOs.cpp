...
{
#ifdef DEBUGTRACE
    if (EC_NULL != S_pfTraceFile)
	{
		fclose(S_pfTraceFile);
	}
...
* \return N/A.
*/
EC_API EC_T_DWORD EC_API_FNCALL OsPlatformImplDeleteThreadHandle(
 ...
 */
EC_API EC_T_DWORD EC_API_FNCALL OsSetThreadAffinity(EC_T_VOID* pvThreadObject, EC_T_CPUSET cpuMask)
{
...
EC_API EC_T_VOID EC_API_FNCALL OsMeasCalibrate(EC_T_UINT64 dwlFreqSet)
{
    ...
    if( !S_bCalibrated )
    {
        ...
        {
            /* auto calibrate */
            EcLogMsg(EC_LOG_LEVEL_VERBOSE, (pEcLogContext, EC_LOG_LEVEL_VERBOSE, "Calibrate tsc measurement... "));
...
EC_API EC_T_DWORD EC_API_FNCALL OsAuxClkInit(EC_T_DWORD dwCpuIndex, EC_T_DWORD dwFrequencyHz, EC_T_VOID* pvOsEvent)
{
    ...
    OsCreateThread((EC_T_CHAR*)"tEcAuxClkTask", (EC_PF_THREADENTRY)AuxClkTask,
            CpuSet, TIMER_THREAD_PRIO, LOG_THREAD_STACKSIZE, EC_NULL);

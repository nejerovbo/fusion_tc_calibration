...
#define       EC_E_SDO_ABORTCODE_DATA_LENGTH_NOT_MATCH      ((EC_T_DWORD)0x98110050)
...
#define       EC_E_SDO_ABORTCODE_DATA_LENGTH_TOO_HIGH       ((EC_T_DWORD)0x98110051)
#define EC_SZTXT_E_SDO_ABORTCODE_DATA_LENGTH_TOO_HIGH       "ERROR SDO: Data type does not match, service parameter too high"

#define       EC_E_SDO_ABORTCODE_DATA_LENGTH_TOO_LOW        ((EC_T_DWORD)0x98110052)
...
#define       EC_E_SDO_ABORTCODE_TRANSFER_LOCAL_CONTROL      ((EC_T_DWORD)0x9811005A)
...
#define       EC_E_SDO_ABORTCODE_TRANSFER_DEVICE_STATE      ((EC_T_DWORD)0x9811005B)
...
/*********************************************************************/
/** \defgroup DCM_ERROR_CODES DCM Error Codes 
@{*/
#define       DCM_E_ERROR                       ((EC_T_DWORD)0x981201C0)    /**< Unspecific DCM Error */
#define DCM_SZTXT_E_ERROR                       "Unspecific DCM Error"

#define       DCM_E_NOTINITIALIZED              ((EC_T_DWORD)0x981201C1)    /**< Not initialized  */
#define DCM_SZTXT_E_NOTINITIALIZED              "ERROR: init function not called or not successful"

#define       DCM_E_MAX_CTL_ERROR_EXCEED        ((EC_T_DWORD)0x981201C2)    /**< DCM controller - synchronisation out of limit */
#define DCM_SZTXT_E_MAX_CTL_ERROR_EXCEED        "ERROR: controller error - synchronisation out of limit"

#define       DCM_E_NOMEMORY                    ((EC_T_DWORD)0x981201C3)    /**< Not enough memory */
#define DCM_SZTXT_E_NOMEMORY                    "ERROR: not enough memory"

#define       DCM_E_INVALID_HWLAYER             ((EC_T_DWORD)0x981201C4)    /**< Hardware layer - (BSP) invalid */
#define DCM_SZTXT_E_INVALID_HWLAYER             "ERROR: hardware layer - (BSP) invalid"

#define       DCM_E_TIMER_MODIFY_ERROR          ((EC_T_DWORD)0x981201C5)    /**< Hardware layer - error modifying timer */
#define DCM_SZTXT_E_TIMER_MODIFY_ERROR          "ERROR: hardware layer - error modifying timer"

#define       DCM_E_TIMER_NOT_RUNNING           ((EC_T_DWORD)0x981201C6)    /**< Hardware layer - timer not running */
#define DCM_SZTXT_E_TIMER_NOT_RUNNING           "ERROR: hardware layer - timer not running"

#define       DCM_E_WRONG_CPU                   ((EC_T_DWORD)0x981201C7)    /**< Hardware layer - function called on wrong CPU */
#define DCM_SZTXT_E_WRONG_CPU                   "ERROR: hardware layer - function called on wrong CPU"

#define       DCM_E_INVALID_SYNC_PERIOD         ((EC_T_DWORD)0x981201C8)    /**< Invalid DC sync period length (invalid clock master?) */
#define DCM_SZTXT_E_INVALID_SYNC_PERIOD         "ERROR: invalid DC sync period length (invalid clock master?)"

#define       DCM_E_INVALID_SETVAL              ((EC_T_DWORD)0x981201C9)    /**< DCM controller SetVal to small */
#define DCM_SZTXT_E_INVALID_SETVAL              "ERROR: Error DCM Controller SetVal to small"

#define       DCM_E_DRIFT_TO_HIGH               ((EC_T_DWORD)0x981201CA)    /**< DCM controller - Drift between local timer and ref clock to high */
#define DCM_SZTXT_E_DRIFT_TO_HIGH               "ERROR: Error DCM Controller - Drift between local timer and ref clock to high"

#define       DCM_E_BUS_CYCLE_WRONG             ((EC_T_DWORD)0x981201CB)    /**< DCM controller - Bus cycle time (dwBusCycleTimeUsec) doesn't match real cycle */
#define DCM_SZTXT_E_BUS_CYCLE_WRONG              "ERROR: Error DCM Controller - Bus cycle time (dwBusCycleTimeUsec) doesn't match real cycle"

#define       DCX_E_NO_EXT_CLOCK                ((EC_T_DWORD)0x981201CC)    /**< DCX controller - No external synchronization clock found */
#define DCX_SZTXT_E_NO_EXT_CLOCK                 "ERROR: Error DCX Controller - No external synchronization clock found"

#define       DCM_E_INVALID_DATA                ((EC_T_DWORD)0x981201CD)    /**< DCM controller - Invalid data */
...
#define EC_SZTXT_TXT_DCM_INSYNC                                     "DCM in sync (cur/avg/max) [nsec]: %7d/%7d/%7d"

#define       EC_TXT_DCM_OUTOFSYNC                                  ((EC_T_WORD)(EC_TEXTBASE+0x0036))
#define EC_SZTXT_TXT_DCM_OUTOFSYNC                                  "DCM out of sync (cur/avg/max) [nsec]: %7d/%7d/%7d"
...
#define EC_SZTXT_TXT_DCX_INSYNC                                     "DCX in sync (cur/avg/max) [nsec]: %7d/%7d/%7d, TimeStamp= %7d"

#define       EC_TXT_DCX_OUTOFSYNC                                  ((EC_T_WORD)(EC_TEXTBASE+0x0039))
#define EC_SZTXT_TXT_DCX_OUTOFSYNC                                  "DCX out of sync (cur/avg/max) [nsec]: %7d/%7d/%7d, TimeStamp= %7d"

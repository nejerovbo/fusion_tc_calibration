...
#define CRAM_12_SLOT_AIN_START  68 // J2/J4
#define CRAM_12_SLOT_AOUT_START 48 // J2/J4
#define CRAM_RIM_5_DIN_START    12 // J8
#define CRAM_RIM_5_DOUT_START   6  // J8

#define MRAM_5_DIN_START    0 // J2
#define MRAM_5_DOUT_START   0  // J2
#define MRAM_5_RELAY_START  1 // J1
#define MRAM_5_AIN_START   0  // J3
#define MRAM_5_AOUT_START  0  // J3

#define ASMI_RIM_5_DIN_START    0 // J7
#define ASMI_RIM_5_DOUT_START   1  // J

#define ASMI_RIM_5_RELAY_START  0 // J3
#define ASMI_RIM_5_AIN_START   0  // J3

#define BECKHOFF_AOUT_OFFSET    847 // Fusion CRAM + Beckhoff EL21258 + EL4123
